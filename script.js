...
setInterval(() => {
    ...
    $(".section1").css("transform","rotateY("+i*1+"deg)")
    i++; 
    if(i==360){
        i=0;
    }
...
for(i=0;i<panels2.length;i++){
    ...
    $(panels2[i]).css("transform","rotateY("+(i*36+180)+"deg )translateZ(250px)")
...
setInterval(() => {
    ...
    $(".section2").css("transform","rotateY("+j*1+"deg)")
    j++; 
    if(j==360){
        j=0;
    }
...
var panels3 = $(".section3 .Panel");
for(i=0;i<panels3.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels3[i]).css("transform","rotateY("+i*36+"deg )translateZ(200px)")
}
var panels4 = $(".section4 .Panel");
for(i=0;i<panels4.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels4[i]).css("transform","rotateY("+i*36+"deg )translateZ(150px)")
}
var panels5 = $(".section5 .Panel");
for(i=0;i<panels5.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels5[i]).css("transform","rotateY("+i*36+"deg )translateZ(100px)")
}
var panels6 = $(".section6 .Panel");
for(i=0;i<panels6.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels6[i]).css("transform","rotateY("+i*36+"deg )translateZ(50px)")
}
var panels7 = $(".section7 .Panel");
for(let i=0;i<panels7.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels7[i]).css("transform","rotateY("+i*36+"deg )translateZ(30px)")
}
var panels7 = $(".section7 .Panel");
for(i=0;i<panels7.length;i++){
    // $(panels[i]).css("left",i*100+"%")

    $(panels7[i]).css("transform","rotateY("+i*36+"deg )translateZ(20px)")
}
var panels5b = $(".space2 .section5 .Panel");
for(i=0;i<panels5b.length;i++){
    // $(panels[i]).css("left",i*100+"%")
...
setInterval(() => {
    ...
    $(".section3").css("transform","rotateY("+k*1+"deg)")
    k++; 
    if(k==360){
        k=0;
    }
...
setInterval(() => {
    ...
    $(".section4").css("transform","rotateY("+k*1+"deg)")
    k++; 
    if(k==360){
        k=0;
    }
...
setInterval(() => {
    ...
    $(".section5").css("transform","rotateY("+k*1+"deg)")
    k++; 
    if(k==360){
        k=0;
    }
...
setInterval(() => {
    ...
    $(".section6").css("transform","rotateY("+k*1+"deg)")
    k++; 
    if(k==260){
        k=0;
    }
...
setInterval(() => {
    ...
    $(".section7").css("transform","rotateY("+k*1+"deg)")
    k++; 
    if(k==360){
        k=0;
    }
...
var newsPanels = $(".space2 .Panel");
// console.log(capturedResponse.articles.length)
// console.log(newsPanels)
for(i=0;i<newsPanels.length;i++){
    let randomnumber = Math.floor(Math.random()*capturedResponse.articles.length)
    var newsimage=$("<img>")
    newsimage.attr("src",capturedResponse.articles[randomnumber].image)
